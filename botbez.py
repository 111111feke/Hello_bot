...
schedule_db = load_json(SCHEDULE_FILE, {
    "2026-03-22 12:00": {"type": "text", "content": "Детка уже совсем скоро this is day, подготовься и сияй", "caption": None},
    "2026-03-23 12:00": {"type": "text", "content": "Baby, с 8 марта! Будь beautiful, неотразимой, amazing и радостной", "caption": None},
    "2026-03-24 12:00": {"type": "text", "content": "Girls, мы проверяем списки и ты уже там, совсем скоро отправим точную date и time", "caption": None},
    "2026-03-25 12:00": {"type": "text", "content": "WELCOME TO CLUB!!! ДА ДА ТЫ НЕ ОСЛЫШАЛАСЬ. Уже завтра состоится наша встреча в ауд. 7-406, 26 марта", "caption": None},
    "2026-03-26 15:00": {"type": "text", "content": "До финала 3 часа и уже наконец ты будешь на острове)))", "caption": None},
})
